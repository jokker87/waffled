...
// Step 1 · Loose ends — reads chores, lists, rhythms and goals.
//
...
// apps/web/src/styles/planning-looseEnds.css, and put its API client in
// apps/web/src/lib/api/planning/looseEnds.ts. See docs/product/weekly-planning-plan.md
