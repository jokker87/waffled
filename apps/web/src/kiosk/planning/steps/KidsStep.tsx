...
// Step 9 · Kids — reads goals and chores.
//
...
// apps/web/src/styles/planning-kids.css, and put its API client in
// apps/web/src/lib/api/planning/kids.ts. See docs/product/weekly-planning-plan.md
