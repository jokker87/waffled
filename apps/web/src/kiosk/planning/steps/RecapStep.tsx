...
// Step 10 · Recap — reads every step above.
//
...
// apps/web/src/styles/planning-recap.css, and put its API client in
// apps/web/src/lib/api/planning/recap.ts. See docs/product/weekly-planning-plan.md
