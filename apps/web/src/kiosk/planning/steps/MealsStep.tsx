...
// Step 7 · Meals — reads the meal plan and groceries.
//
...
// apps/web/src/styles/planning-meals.css, and put its API client in
// apps/web/src/lib/api/planning/meals.ts. See docs/product/weekly-planning-plan.md
