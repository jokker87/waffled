...
// Step 2 · Calendar — reads the calendar.
//
...
// apps/web/src/styles/planning-calendar.css, and put its API client in
// apps/web/src/lib/api/planning/calendar.ts. See docs/product/weekly-planning-plan.md
