...
// Step 6 · Goals — reads goals and goal lists.
//
...
// apps/web/src/styles/planning-goals.css, and put its API client in
// apps/web/src/lib/api/planning/goals.ts. See docs/product/weekly-planning-plan.md
