...
// Step 4 · Family night — reads the familyNight module.
//
...
// apps/web/src/styles/planning-familyNight.css, and put its API client in
// apps/web/src/lib/api/planning/familyNight.ts. See docs/product/weekly-planning-plan.md
