...
// Step 4 · Family night — the reads this step needs over the familyNight module.
//
...
// sibling `familyNight.ts`; integration tests in
// apps/api/test/weekly-planning-familyNight.integration.test.ts.
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const { tenantRoute, adminRoute } = moduleRoutes('weeklyPlanning')

export function registerFamilyNightStepRoutes(_api: Api): void {
  // e.g. _api.get('/api/weekly-planning/familyNight', tenantRoute(async (tenant) => { … }))
}
